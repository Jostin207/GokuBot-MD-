...
mobile: MethodMobile, 
browser: opcion == '1' ? ['GokuBot', 'Edge', '2.0.0'] : methodCodeQR ? ['GokuBot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
if (connection == 'open') {
await conn.groupAcceptInvite(Gd85w1s6tKh5Nw4p490xBw)
