...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    restrict: '✰ *¡Esta Función Fué Deshabilitado Por Mi Desarrollador!*',
        ...
        if (msg) return conn.sendMessage(m.chat, { text: msg, contextInfo: { mentionedJid: [m.sender], forwardingScore: 9999, isForwarded: true, externalAdReply: { title: global.packname, body: 'ꪶໍٜ߭۫ިׅ࣪۬߭ׄ🥷ꫂꥈ Hola! ' + nombre, thumbnail: gataImg.getRandom(), sourceUrl: channel, mediaType: 1}}}, { quoted: m }).then(_ => m.react('✖️'))}
