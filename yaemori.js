...
global.authFile = `YaemoriSession`
global.authFileJB = `YaemoriJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['YaemoriBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['YaemoriBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
