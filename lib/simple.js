    ...
    return await conn.sendMessage(jid, {
      ...
      ...options
        ...
        reply: {
             ...
             * @param {Object} options
             */
            value(jid, text = '', quoted, options) {                           return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, forwardedNewsletterMessageInfo: { newsletterJid: "120363263466636910@newsletter", serverMessageId: '', newsletterName: packname }, forwardingScore: 9999999, isForwarded: true, ...options }}, { quoted, ...options })
            }
        },
