...
let handler = async (m, { conn, text, isOwner, usedPrefix, command }) => {
  ...
  let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("6289643739077-1613049930@g.us" ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title": wm, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': 'Emilia estuvo aquí ^~^', 'jpegThumbnail': false }}}
  ...
  await m.reply(`🤍 *Listo Mi Moderador!*`)
}
