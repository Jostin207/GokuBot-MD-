...
let parentw = conn
if (conn.user.jid !== global.conn.user.jid) return parentw.reply(m.chat, `💭 Este comando solo puede ser usado en el bot principal\n\n● Wa.me/${global.conn.user.jid.split`@`[0]}&text=${usedPrefix + command}`, fkontak)
