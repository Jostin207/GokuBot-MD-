...
let handler = async (_0x7880ea, {
  ...
  if (_0x3740e2.user.jid !== global.conn.user.jid) {
    return _0x3740e2.reply(_0x7880ea.chat, "" + " wa.me/" + global.conn.user.jid.split`@`[0x0] + "&text=" + (_0x3b835b + _0x37fa95), _0x7880ea);
  }
...
args[0] = args[0].replace('--code', '').trim()*/
    ...
    const _0xbe00d5 = {
      ...
      'browser': _0x4bf714 ? ["Ubuntu", 'Chrome', "20.0.04"] : ["GataBot-MD (Sub-Bot)", "Safari", "2.0.0"],
    ...
    async function _0x3c8cc7(_0x3457a1) {
      ...
      if (_0x62fe70 && !_0x4bf714) {
        _0x3740e2.sendMessage(_0x7880ea.chat, {
          ...
          'caption': "serbot codigo qr" + _0x16317d.toString("utf-8")
        }, {
          'quoted': _0x7880ea
        });
      }
      if (_0x62fe70 && _0x4bf714) {
        ...
        _0x3740e2.sendMessage(_0x7880ea.chat, {
          'text': "subbot code 8 digitos" + _0x16317d.toString("utf-8")
        }, {
          'quoted': _0x7880ea
        });
        await delay(0x1388);
