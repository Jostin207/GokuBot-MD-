...
m.react('🕒') 
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: packname, body: team, thumbnail: yoshiImg, sourceUrl: yt}, mentionedJid: [m.sender]}}}, aa);
