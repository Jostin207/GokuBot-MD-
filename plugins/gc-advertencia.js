...
if (m.mentionedJid.includes(global.owner)) return;     return m.reply(`El propietario de *YoshikoBot-MD* no puede ser advertido`, m.chat, { mentions: conn.parseMention(`@${owner}`) });
